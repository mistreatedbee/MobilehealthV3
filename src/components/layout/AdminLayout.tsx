...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    { path: '/admin/patients', icon: UsersIcon, label: 'Patients' },
    { path: '/admin/doctors', icon: UserCheckIcon, label: 'Doctors' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-red-500 rounded-full flex items-center justify-center shadow-md">
                <HeartIcon className="w-6 h-6 text-white" />
              </div>
              <h1 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-red-600 bg-clip-text text-transparent">
                MobileHealth - Admin Portal
              </h1>
            </div>
                    ...
                    <li key={item.path}>
                      <Link
                        ...
                        className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                          isActive
                            ? 'bg-gradient-to-r from-purple-500 to-red-500 text-white shadow-lg border border-purple-300/50'
